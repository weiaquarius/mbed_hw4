...
void GetAccData(Arguments *in, Reply *out)
{
    ...
    // output count
    t = sprintf(c, "%02d", ACCcount);
    xbee.printf("%s", c);
    // pc.printf("%d\r\n",ACCcount);   
    // wait_us(200000);

    // output X
    t = sprintf(acc, "%+1.3f", tf[0]);
    xbee.printf("%s", acc);
    // pc.printf("%+1.3f", tf[0]);
    // wait_us(200000);

    // output Y
    t = sprintf(acc, "%+1.3f", tf[1]);
    xbee.printf("%s", acc);
    // pc.printf("%+1.3f", tf[1]);
    // wait_us(200000);

    // output Z 
    t = sprintf(acc, "%+1.3f", tf[2]);
    xbee.printf("%s", acc);
    // pc.printf("%+1.3f", tf[2]);
    // wait_us(200000);
...
int main()
{
  ...
  xbee.printf("ATMY 256\r\n");
  reply_messange(xbee_reply, "setting MY : 256");

  xbee.printf("ATDL 156\r\n");
  reply_messange(xbee_reply, "setting DL : 156");
